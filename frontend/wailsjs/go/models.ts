...
export namespace lolbuild {
	...
	export class Build {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.skillMaxOrder = source["skillMaxOrder"];
	        this.skillOrder = source["skillOrder"];
	    }
	...
	export class Passive {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.name = source["name"];
	        this.image = this.convertValues(source["image"], SpellImage);
	    }
	...
	export class ChampionData {
	    ...
	    static createFrom(source: any = {}) {
	        return new ChampionData(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.spells = this.convertValues(source["spells"], Spell);
	        this.passive = this.convertValues(source["passive"], Passive);
	    }
